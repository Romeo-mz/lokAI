...
func main() {
	...
	useCaseFlag := flag.String("use-case", "", "Use case for non-interactive mode: chat|code|vision|embedding|reasoning|image|video|audio|nsfw")
	...
	// Show heretic suggestion for Uncensored/uncensored use case.
