...
const (
	...
	UseCaseNSFW      = hardware.UseCaseNSFW
)
...
var Catalog = []ModelEntry{
	...
	// ═══════════════════════════════════════════
	{
		...
		UseCases: []UseCase{UseCaseNSFW, UseCaseChat}, Capabilities: []string{"uncensored"},
		Quality: 28, Description: "Tiny uncensored chat model — very low hardware requirements",
	},
	{
		...
		UseCases: []UseCase{UseCaseNSFW, UseCaseChat}, Capabilities: []string{"uncensored"},
		Quality: 40, Description: "Uncensored Llama 2 — no built-in content filters",
	},
	{
		...
		DiskSizeGB: 4.1, EstimatedVRAMGB: 6.0,
		UseCases: []UseCase{UseCaseNSFW, UseCaseChat}, Capabilities: []string{"uncensored"},
		Quality: 52, Description: "Uncensored Mistral — strong general-purpose without filters",
	},
	{
		...
		DiskSizeGB: 4.7, EstimatedVRAMGB: 6.5,
		UseCases: []UseCase{UseCaseNSFW, UseCaseChat}, Capabilities: []string{"uncensored"},
		Quality: 58, Description: "Uncensored Llama 3 — high quality without content restrictions",
	},
	{
		...
		UseCases: []UseCase{UseCaseNSFW, UseCaseChat}, Capabilities: []string{"uncensored"},
		Quality: 65, Description: "Classic uncensored model — well-known for unrestricted output",
	},
	{
		...
		UseCases: []UseCase{UseCaseNSFW, UseCaseChat}, Capabilities: []string{"uncensored"},
		Quality: 78, Description: "Uncensored Mixtral MoE — top quality unrestricted model",
	},
}
